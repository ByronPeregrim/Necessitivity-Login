  ...
  return (
    <Container className={styles.wrapper}>
      ...
      <div className={styles.calories_burned_wrapper}>
        <div>
          <div>
            <div className={styles.calorie_data}>{showTodaysCalories}</div>
      ...
      {showCalendar ? (
        <div className={styles.calendar_wrapper}>
          ...
          <Calendar
            id={id}
            value={currentDate}
            setCalories={setSelectedDatesCalories}
            onChange={setCurrentDate}
            onCellClicked={setClickedCellDay}
            onDateSet={() => [setShowEditDate(true), setShowCalendar(false)]}
          />
        </div>
      ) : null}
      ...
      {showEditDate ? (
        <div className={styles.calendar_wrapper}>
          <EditWorkoutModal
            ...
            value={currentDate}
            day={clickedCellDay}
            currentCalories={selectedDatesCalories}
