      ...
      >
        ...
        <InputField
          ...
          registerOptions={{
            ...
            validate: {
              notIncorrectSize: (fieldValue) => {
                return fieldValue.length < 41 || "Email is invalid";
              },
            },
          }}
        />
