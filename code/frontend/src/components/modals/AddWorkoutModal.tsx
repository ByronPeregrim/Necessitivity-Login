    ...
    if (userWeight !== undefined) {
      if (exercise !== "") {
        if (duration <= 180 && duration > 0) {
          ...
          let caloriesBurned =
            ((METScore * 3.5 * (userWeight / 2.205)) / 200) * duration;
        ...
        <div className={styles.modal_wrapper}>
          ...
          <div className={styles.add_workout_wrapper}>
            <div className={styles.add_exercise_wrapper}>
              ...
              <label className={styles.duration_label} htmlFor="duration">
                Duration (mins):
              </label>
              ...
              <p>
                Estimated Calories:<b>{estimatedCalories}</b>
              </p>
              <Button
                type="button"
                disabled={isSubmitting}
                onClick={() =>
                  setTotalCalories(totalCalories + estimatedCalories)
                }
            ...
            <div className={styles.add_calories_wrapper}>
              <Form onSubmit={handleSubmit(onSubmit)}>
                ...
                <input
                  type="hidden"
                  {...register("date")}
                  defaultValue={moment().format("MMM D YY")}
                />
                <div className={styles.total_calories_box}>
                  <p className={styles.total_calories_text}>
                    <b>Total Calories: </b>
                  </p>
                  <input
                    type="number"
