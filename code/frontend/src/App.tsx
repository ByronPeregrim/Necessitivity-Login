...
const App = () => {
  ...
  const [showAccountRecoveryModal, setShowAccountRecoveryModal] =
    useState(false);
  const [showAccountRecoverySuccess, setShowAccountRecoverySuccess] =
    useState(false);
              ...
              element={
                <UserPage
                  ...
                  onAccountRecoveryClicked={() => {
                    setShowAccountRecoveryModal(true);
                  }}
                />
              }
            />
            ...
            <>
              <AccountRecoveryModal
                ...
                onRecoverySuccessful={() => [
                  setShowAccountRecoverySuccess(true),
                  setShowAccountRecoveryModal(false),
                ]}
              />
            </>
